...
class UwbCalibration{
    private:
        ros::Publisher _pub;
        uwb_ins_eskf_msgs::uwbRAW _data_calibrated;
    ...
    public:
        ...
        void Calibration(uwb_ins_eskf_msgs::uwbRAW raw_data);
...
void UwbCalibration::Calibration(uwb_ins_eskf_msgs::uwbRAW raw_data){
...
void UwbCalibration::UwbrawCallback(const uwb_ins_eskf_msgs::uwbRAW& msg){
    Calibration(msg);
...
int main(int argc, char **argv) {
    ...
    ros::Publisher pub = n.advertise<uwb_ins_eskf_msgs::uwbRAW>("uwb_calibration", 1);
